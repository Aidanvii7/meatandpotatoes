...
public class TransactionRemove1Test extends TransactionBaseTest<Integer, String> {

    public TransactionRemove1Test(Parameter<Integer, String> parameter) {
        super(parameter);
    }
    ...
    public static Iterable<Parameter<Integer, String>> getParameters() {
        ...
        Transaction<Integer> transaction = new TransactionRemove<>(1);
    ...
    protected void verifyTransformedType(Transaction<String> transformedTransaction) {
        assertTrue(transformedTransaction instanceof TransactionRemove);
    }

    @Override
    protected void verifyTransactionApplied(TransactionSortedList<Integer> enhancedSortedList, Transaction<Integer> transaction) {
        verify(enhancedSortedList).remove(((TransactionRemove<Integer>) transaction).item);
